...
var lastClickedCity: String = ""

fun changeGlobal(city: String) {
...
class CityRepository {
    ...
    fun removeCity(removeCity: String) {
        _cities.remove(removeCity)
    }
}
